...
import { Card, Row, Col, Button, Spinner, Alert, Container, Image } from 'react-bootstrap';
import { FaCheckCircle, FaChartLine, FaBolt, FaRedo, FaStar } from 'react-icons/fa';
...
const ProgressScreen = () => {
  ...
  <div className="col-lg-8 wow fadeInUp mx-auto" data-wow-delay="0.1s">
    ...
    {isLoading ? (
      ...
      <Alert variant="danger" className="text-center">{error?.data?.message || 'Something went wrong'}</Alert>
    ) : (
      <>
        <Row className="mb-4 align-items-center justify-content-center">
          ...
          <Col md={6}>
            ...
            <p className="text-muted text-center">Subject: <strong>{progress?.subject?.subjectName}</strong></p>
          </Col>
        </Row>
          ...
          <Col md={4}>
            <Card className="text-center shadow-sm border-0 rounded-4 mb-4">
              <Card.Body>
                ...
                <Card.Text>{progress?.correctAnswers}</Card.Text>
              </Card.Body>
            </Card>
          </Col>
          <Col md={4}>
            <Card className="text-center shadow-sm border-0 rounded-4 mb-4">
              <Card.Body>
                ...
                <Card.Text>{progress?.totalAttempts}</Card.Text>
              </Card.Body>
            </Card>
          </Col>
          <Col md={4}>
            <Card className="text-center shadow-sm border-0 rounded-4 mb-4">
              <Card.Body>
                ...
                <Card.Text>{progress?.currentStreak}</Card.Text>
              </Card.Body>
            </Card>
          </Col>
          <Col md={4}>
            <Card className="text-center shadow-sm border-0 rounded-4 mb-4">
              <Card.Body>
                ...
                <Card.Text>{progress?.maxStreak}</Card.Text>
              </Card.Body>
            </Card>
          </Col>
          <Col md={4}>
            <Card className="text-center shadow-sm border-0 rounded-4 mb-4">
              <Card.Body>
                ...
                <Card.Text>{progress?.averageScore.toFixed(2)}%</Card.Text>
              </Card.Body>
            </Card>
          </Col>
          <Col md={4}>
